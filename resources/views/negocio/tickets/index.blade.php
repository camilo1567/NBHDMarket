...
@section('content')
    <div class="py-2">
        <div class="flex justify-start">
            <a href="{{ route('negocio.tickets.create') }}" class="btn-primary">
                Nuevo
            </a>
        </div>
    </div>
                    ...
                    <div class="p-0 overflow-y-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
                        ...
                        @foreach ($tickets as $ticket)
                            <div class="bg-slate-100 rounded-lg shadow-lg p-6 ">
                                ...
                                {{-- <h2 class="text-lg font-semibold mb-2">Tu número de ticket es: #{{ sprintf('%03d', $ticket->id) }}</h2> --}}

                                <p class="text-gray-600 mb-4">Fecha:
                                    {{ $ticket->created_at->sub(new DateInterval('PT5H'))->format('d/m/Y') }}</p>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="{{ route('negocio.tickets.edit', $ticket) }}" class="btn-primary">
                                        Ver Detalles
                                    </a>
                                </div>
                            </div>
