...
@section('content')
    <div class="container mx-auto p-8 w-[90%]">
        <div class="mb-10">
            ...
            <section
                class="mx-auto p-6 mt-10 mb-4 w-full bg-white rounded-lg shadow-lg text-gray-700 hover:text-white hover:bg-blue-700 hover:-translate-y-2 transition duration-300">
