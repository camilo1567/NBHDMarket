<nav class="bg-white">
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        ...
        {{-- <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <div class="flex flex-row justify-end gap-2 pl-0 mb-0 list-none md-max:w-full">
                <li class="flex items-center">
                    <a href="#" class="flex items-center block px-0 py-2 text-sm font-semibold transition-all ease-nav-brand text-slate-500">
