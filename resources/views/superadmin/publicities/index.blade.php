...
@section('content')
    ...
    <div class="py-2">
        <div class="flex justify-start">
            <a href="{{ route('superadmin.publicities.create') }}" class="btn-primary">
                Nuevo
            </a>
        </div>
    </div>
        ...
        <div class="p-0 overflow-y-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            ...
            @foreach ($publicities as $publicity)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="{{ route('superadmin.publicities.edit',$publicity) }}" class="flex justify-center">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('superadmin.publicities.edit',$publicity) }}" class="btn-primary">
                            ...
                            {{ Aire::open()->route('superadmin.publicities.destroy', $publicity) }}
